...
clang++ "-ldl" "-rdynamic" input-gen-out/merged.bc "-o" "./input-gen-out//input-gen.function.kernel_gemm.generate.a.out" "-O3" "-DNDEBUG"

llvm-link input-gen-out/input-gen.function.kernel_gemm.run.bc rt-run.bc -o input-gen-out/merged_run.bc
clang++ "-ldl" "-rdynamic" input-gen-out/merged_run.bc "-o" "./input-gen-out//input-gen.function.kernel_gemm.run.a.out" "-O3" "-DNDEBUG"
...
clang -O3 gemm.c -o gemm.org -I../../../utilities/ ../../../utilities/polybench.c -DMAIN -DPOLYBENCH_TIME
